...
export default function SellWithMCMContact() {
  ...
  return (
      ...
      <section style={{ maxWidth: 900, margin: "2em auto", padding: "1.5em" }}>
        <div id="contact" style={{ position: "relative", width: "100%", paddingBottom: "95vh", height: 0, overflow: "hidden", borderRadius: "1em", boxShadow: "0 2px 8px rgba(193, 18, 31, 0.08)" }}>
          <iframe
            src="https://docs.google.com/forms/d/e/1FAIpQLSeWp9TaGlu2qlyShStrPJin7EiYkzXoaiXshrH74gqh-Msheg/viewform?embedded=true"
            title="Contact Form"
            style={{
              position: "absolute",
              top: 0,
